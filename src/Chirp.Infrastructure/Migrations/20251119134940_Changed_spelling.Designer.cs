...
namespace Chirp.Infrastructure.Migrations
{
    ...
    [Migration("20251119134940_Changed_spelling")]
    partial class Changed_spelling
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Chirp.Domain.Follow", b =>
                {
            ...
            modelBuilder.Entity("Chirp.Domain.Follow", b =>
                {
                    b.HasOne("Chirp.Domain.User", "Followee")
                        .WithMany()
                        .HasForeignKey("FolloweeId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Chirp.Domain.User", "Follower")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Chirp.Domain.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
